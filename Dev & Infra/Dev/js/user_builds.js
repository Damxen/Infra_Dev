    ...
    .then(builds => {
        ...
        builds.forEach(build => {
            ...
            buildElement.innerHTML = `
                ...
                <div class="champion">
                    ${build.champion_image ? `<img src="http://ddragon.leagueoflegends.com/cdn/14.10.1/img/champion/${build.champion_image}" alt="Champion Image">` : 'None'}
                </div>
                <p>Created At: ${new Date(build.created_at).toLocaleString()}</p>
            `;
